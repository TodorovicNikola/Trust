...
public class Process_modelingFactoryImpl extends EFactoryImpl implements Process_modelingFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case Process_modelingPackage.COLLABORATIVE_NETWORK: return createCollaborativeNetwork();
	 ...
	 * @generated
	 */
	public CollaborativeNetwork createCollaborativeNetwork() {
		CollaborativeNetworkImpl collaborativeNetwork = new CollaborativeNetworkImpl();
