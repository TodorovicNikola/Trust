 ...
 * </p>
 * <ul>
 *   <li>{@link process_modeling.impl.GateImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GateImpl extends ProcessElementImpl implements Gate {
	...
	protected EClass eStaticClass() {
		return Process_modelingPackage.Literals.GATE;
	}
	...
	public void setType(EGateType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Process_modelingPackage.GATE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Process_modelingPackage.GATE__TYPE:
				return getType();
		}
