...
public interface Process_modelingPackage extends EPackage {
	...
	/**
	 * The operation id for the '<em>Must Exists End</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROCESS___MUST_EXISTS_END__DIAGNOSTICCHAIN_MAP = ID_NAMED_ELEMENT_OPERATION_COUNT + 0;

	/**
	 * The operation id for the '<em>One End Process Step</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROCESS___ONE_END_PROCESS_STEP__DIAGNOSTICCHAIN_MAP = ID_NAMED_ELEMENT_OPERATION_COUNT + 1;

	/**
	 * The operation id for the '<em>One Start Process Step2</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROCESS___ONE_START_PROCESS_STEP2__DIAGNOSTICCHAIN_MAP = ID_NAMED_ELEMENT_OPERATION_COUNT + 2;

	/**
	 * The operation id for the '<em>Must Exists Start</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROCESS___MUST_EXISTS_START__DIAGNOSTICCHAIN_MAP = ID_NAMED_ELEMENT_OPERATION_COUNT + 3;

	/**
	 * The operation id for the '<em>One Start Process Step</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROCESS___ONE_START_PROCESS_STEP__DIAGNOSTICCHAIN_MAP = ID_NAMED_ELEMENT_OPERATION_COUNT + 4;
	 ...
	 * @ordered
	 */
	int PROCESS_OPERATION_COUNT = ID_NAMED_ELEMENT_OPERATION_COUNT + 5;
	...
	/**
	 * The operation id for the '<em>Start Process Step Has Only One Link To</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROCESS_STEP___START_PROCESS_STEP_HAS_ONLY_ONE_LINK_TO__DIAGNOSTICCHAIN_MAP = PROCESS_ELEMENT_OPERATION_COUNT + 0;

	/**
	 * The operation id for the '<em>Only One Flow Relation Process Step</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROCESS_STEP___ONLY_ONE_FLOW_RELATION_PROCESS_STEP__DIAGNOSTICCHAIN_MAP = PROCESS_ELEMENT_OPERATION_COUNT + 1;

	/**
	 * The operation id for the '<em>Start Process Step Has Only One Link To2</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROCESS_STEP___START_PROCESS_STEP_HAS_ONLY_ONE_LINK_TO2__DIAGNOSTICCHAIN_MAP = PROCESS_ELEMENT_OPERATION_COUNT + 2;

	/**
	 * The operation id for the '<em>End Process Step Has Only One Link From</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PROCESS_STEP___END_PROCESS_STEP_HAS_ONLY_ONE_LINK_FROM__DIAGNOSTICCHAIN_MAP = PROCESS_ELEMENT_OPERATION_COUNT + 3;
	 ...
	 * @ordered
	 */
	int PROCESS_STEP_OPERATION_COUNT = PROCESS_ELEMENT_OPERATION_COUNT + 4;
	...
	/**
	 * The operation id for the '<em>Collaboration Between Steps</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RELATIONSHIP___COLLABORATION_BETWEEN_STEPS__DIAGNOSTICCHAIN_MAP = ID_NAMED_ELEMENT_OPERATION_COUNT + 0;

	/**
	 * The operation id for the '<em>Flow Between Steps And Gates</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RELATIONSHIP___FLOW_BETWEEN_STEPS_AND_GATES__DIAGNOSTICCHAIN_MAP = ID_NAMED_ELEMENT_OPERATION_COUNT + 1;

	/**
	 * The operation id for the '<em>Only One Relation Between Elements</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RELATIONSHIP___ONLY_ONE_RELATION_BETWEEN_ELEMENTS__DIAGNOSTICCHAIN_MAP = ID_NAMED_ELEMENT_OPERATION_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RELATIONSHIP_OPERATION_COUNT = ID_NAMED_ELEMENT_OPERATION_COUNT + 3;
	...
	/**
	 * The meta object id for the '{@link process_modeling.impl.CollaborativeNetworkImpl <em>Collaborative Network</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see process_modeling.impl.CollaborativeNetworkImpl
	 * @see process_modeling.impl.Process_modelingPackageImpl#getCollaborativeNetwork()
	 * @generated
	 */
	int COLLABORATIVE_NETWORK = 17;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__ID = PROCESS_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__NAME = PROCESS_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__EXPOSE_TO_COLLABORATING_PARTIES = PROCESS_ELEMENT__EXPOSE_TO_COLLABORATING_PARTIES;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__ALIAS = PROCESS_ELEMENT__ALIAS;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__IS_TRACED = PROCESS_ELEMENT__IS_TRACED;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__LOG_START_TIME = PROCESS_ELEMENT__LOG_START_TIME;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__LOG_END_TIME = PROCESS_ELEMENT__LOG_END_TIME;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__IN_RELATIONSHIPS = PROCESS_ELEMENT__IN_RELATIONSHIPS;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__OUT_RELATIONSHIPS = PROCESS_ELEMENT__OUT_RELATIONSHIPS;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__IS_ERROR_GROUP = PROCESS_ELEMENT__IS_ERROR_GROUP;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__STATUS = PROCESS_ELEMENT__STATUS;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__OBLIGATIONS_FULFILLED = PROCESS_ELEMENT__OBLIGATIONS_FULFILLED;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__RELATED_DLT_CONTENT = PROCESS_ELEMENT__RELATED_DLT_CONTENT;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__ORGANIZATIONS = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK__ENDORSEMENT_POLICY = PROCESS_ELEMENT_FEATURE_COUNT + 1;

	/**
	 * The number of structural features of the '<em>Collaborative Network</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 2;

	/**
	 * The number of operations of the '<em>Collaborative Network</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int COLLABORATIVE_NETWORK_OPERATION_COUNT = PROCESS_ELEMENT_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the '{@link process_modeling.Process#mustExistsEnd(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Must Exists End</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Must Exists End</em>' operation.
	 * @see process_modeling.Process#mustExistsEnd(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getProcess__MustExistsEnd__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link process_modeling.Process#oneEndProcessStep(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>One End Process Step</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>One End Process Step</em>' operation.
	 * @see process_modeling.Process#oneEndProcessStep(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getProcess__OneEndProcessStep__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link process_modeling.Process#oneStartProcessStep2(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>One Start Process Step2</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>One Start Process Step2</em>' operation.
	 * @see process_modeling.Process#oneStartProcessStep2(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getProcess__OneStartProcessStep2__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link process_modeling.Process#mustExistsStart(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Must Exists Start</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Must Exists Start</em>' operation.
	 * @see process_modeling.Process#mustExistsStart(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getProcess__MustExistsStart__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link process_modeling.Process#oneStartProcessStep(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>One Start Process Step</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>One Start Process Step</em>' operation.
	 * @see process_modeling.Process#oneStartProcessStep(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getProcess__OneStartProcessStep__DiagnosticChain_Map();
	...
	/**
	 * Returns the meta object for the '{@link process_modeling.ProcessStep#startProcessStepHasOnlyOneLinkTo(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Start Process Step Has Only One Link To</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Start Process Step Has Only One Link To</em>' operation.
	 * @see process_modeling.ProcessStep#startProcessStepHasOnlyOneLinkTo(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getProcessStep__StartProcessStepHasOnlyOneLinkTo__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link process_modeling.ProcessStep#onlyOneFlowRelationProcessStep(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Only One Flow Relation Process Step</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Only One Flow Relation Process Step</em>' operation.
	 * @see process_modeling.ProcessStep#onlyOneFlowRelationProcessStep(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getProcessStep__OnlyOneFlowRelationProcessStep__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link process_modeling.ProcessStep#startProcessStepHasOnlyOneLinkTo2(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Start Process Step Has Only One Link To2</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Start Process Step Has Only One Link To2</em>' operation.
	 * @see process_modeling.ProcessStep#startProcessStepHasOnlyOneLinkTo2(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getProcessStep__StartProcessStepHasOnlyOneLinkTo2__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link process_modeling.ProcessStep#endProcessStepHasOnlyOneLinkFrom(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>End Process Step Has Only One Link From</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>End Process Step Has Only One Link From</em>' operation.
	 * @see process_modeling.ProcessStep#endProcessStepHasOnlyOneLinkFrom(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getProcessStep__EndProcessStepHasOnlyOneLinkFrom__DiagnosticChain_Map();
	...
	/**
	 * Returns the meta object for the '{@link process_modeling.Relationship#collaborationBetweenSteps(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Collaboration Between Steps</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Collaboration Between Steps</em>' operation.
	 * @see process_modeling.Relationship#collaborationBetweenSteps(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getRelationship__CollaborationBetweenSteps__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link process_modeling.Relationship#flowBetweenStepsAndGates(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Flow Between Steps And Gates</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Flow Between Steps And Gates</em>' operation.
	 * @see process_modeling.Relationship#flowBetweenStepsAndGates(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getRelationship__FlowBetweenStepsAndGates__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link process_modeling.Relationship#onlyOneRelationBetweenElements(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Only One Relation Between Elements</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Only One Relation Between Elements</em>' operation.
	 * @see process_modeling.Relationship#onlyOneRelationBetweenElements(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getRelationship__OnlyOneRelationBetweenElements__DiagnosticChain_Map();
	...
	/**
	 * Returns the meta object for class '{@link process_modeling.CollaborativeNetwork <em>Collaborative Network</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Collaborative Network</em>'.
	 * @see process_modeling.CollaborativeNetwork
	 * @generated
	 */
	EClass getCollaborativeNetwork();

	/**
	 * Returns the meta object for the containment reference list '{@link process_modeling.CollaborativeNetwork#getOrganizations <em>Organizations</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Organizations</em>'.
	 * @see process_modeling.CollaborativeNetwork#getOrganizations()
	 * @see #getCollaborativeNetwork()
	 * @generated
	 */
	EReference getCollaborativeNetwork_Organizations();

	/**
	 * Returns the meta object for the attribute '{@link process_modeling.CollaborativeNetwork#getEndorsementPolicy <em>Endorsement Policy</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Endorsement Policy</em>'.
	 * @see process_modeling.CollaborativeNetwork#getEndorsementPolicy()
	 * @see #getCollaborativeNetwork()
	 * @generated
	 */
	EAttribute getCollaborativeNetwork_EndorsementPolicy();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Must Exists End</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PROCESS___MUST_EXISTS_END__DIAGNOSTICCHAIN_MAP = eINSTANCE.getProcess__MustExistsEnd__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>One End Process Step</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PROCESS___ONE_END_PROCESS_STEP__DIAGNOSTICCHAIN_MAP = eINSTANCE.getProcess__OneEndProcessStep__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>One Start Process Step2</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PROCESS___ONE_START_PROCESS_STEP2__DIAGNOSTICCHAIN_MAP = eINSTANCE.getProcess__OneStartProcessStep2__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>Must Exists Start</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PROCESS___MUST_EXISTS_START__DIAGNOSTICCHAIN_MAP = eINSTANCE.getProcess__MustExistsStart__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>One Start Process Step</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PROCESS___ONE_START_PROCESS_STEP__DIAGNOSTICCHAIN_MAP = eINSTANCE.getProcess__OneStartProcessStep__DiagnosticChain_Map();
		...
		/**
		 * The meta object literal for the '<em><b>Start Process Step Has Only One Link To</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PROCESS_STEP___START_PROCESS_STEP_HAS_ONLY_ONE_LINK_TO__DIAGNOSTICCHAIN_MAP = eINSTANCE.getProcessStep__StartProcessStepHasOnlyOneLinkTo__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>Only One Flow Relation Process Step</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PROCESS_STEP___ONLY_ONE_FLOW_RELATION_PROCESS_STEP__DIAGNOSTICCHAIN_MAP = eINSTANCE.getProcessStep__OnlyOneFlowRelationProcessStep__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>Start Process Step Has Only One Link To2</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PROCESS_STEP___START_PROCESS_STEP_HAS_ONLY_ONE_LINK_TO2__DIAGNOSTICCHAIN_MAP = eINSTANCE.getProcessStep__StartProcessStepHasOnlyOneLinkTo2__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>End Process Step Has Only One Link From</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PROCESS_STEP___END_PROCESS_STEP_HAS_ONLY_ONE_LINK_FROM__DIAGNOSTICCHAIN_MAP = eINSTANCE.getProcessStep__EndProcessStepHasOnlyOneLinkFrom__DiagnosticChain_Map();
		...
		/**
		 * The meta object literal for the '<em><b>Collaboration Between Steps</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation RELATIONSHIP___COLLABORATION_BETWEEN_STEPS__DIAGNOSTICCHAIN_MAP = eINSTANCE.getRelationship__CollaborationBetweenSteps__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>Flow Between Steps And Gates</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation RELATIONSHIP___FLOW_BETWEEN_STEPS_AND_GATES__DIAGNOSTICCHAIN_MAP = eINSTANCE.getRelationship__FlowBetweenStepsAndGates__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>Only One Relation Between Elements</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation RELATIONSHIP___ONLY_ONE_RELATION_BETWEEN_ELEMENTS__DIAGNOSTICCHAIN_MAP = eINSTANCE.getRelationship__OnlyOneRelationBetweenElements__DiagnosticChain_Map();
		...
		/**
		 * The meta object literal for the '{@link process_modeling.impl.CollaborativeNetworkImpl <em>Collaborative Network</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see process_modeling.impl.CollaborativeNetworkImpl
		 * @see process_modeling.impl.Process_modelingPackageImpl#getCollaborativeNetwork()
		 * @generated
		 */
		EClass COLLABORATIVE_NETWORK = eINSTANCE.getCollaborativeNetwork();
		 ...
		 * @generated
		 */
		EReference COLLABORATIVE_NETWORK__ORGANIZATIONS = eINSTANCE.getCollaborativeNetwork_Organizations();
		 ...
		 * @generated
		 */
		EAttribute COLLABORATIVE_NETWORK__ENDORSEMENT_POLICY = eINSTANCE.getCollaborativeNetwork_EndorsementPolicy();
