...
public class Process_modelingAdapterFactory extends AdapterFactoryImpl {
	...
	protected Process_modelingSwitch<Adapter> modelSwitch =
		new Process_modelingSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCollaborativeNetwork(CollaborativeNetwork object) {
				return createCollaborativeNetworkAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseContractualObligation(ContractualObligation object) {
				return createContractualObligationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link process_modeling.CollaborativeNetwork <em>Collaborative Network</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCollaborativeNetworkAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link process_modeling.Organization <em>Organization</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link process_modeling.ContractualObligation <em>Contractual Obligation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
