...
func (fe *Execution) Execute(action string, actionArgsMap map[string]interface{}) error {
	...
	switch action {
     case "El_FA01_FrameAssembling___6d9c":
         retVal = fe.El_FA01_FrameAssembling___6d9cFunc(actionArgsMap)
     case "El_BAH01_BackSideHammerin___a27d":
         retVal = fe.El_BAH01_BackSideHammerin___a27dFunc(actionArgsMap)
     case "El_NT_SQ_04_PI001_Discard___bdec":
         retVal = fe.El_NT_SQ_04_PI001_Discard___bdecFunc(actionArgsMap)
     case "El_BI01_BoxInspection___6ee4":
         retVal = fe.El_BI01_BoxInspection___6ee4Func(actionArgsMap)
     case "El_SA01_SideAssembling_L____bdc3":
         retVal = fe.El_SA01_SideAssembling_L____bdc3Func(actionArgsMap)
     case "El_Start___7def":
         retVal = fe.El_Start___7defFunc(actionArgsMap)
     case "El_PA01_Packaging___8f3d":
         retVal = fe.El_PA01_Packaging___8f3dFunc(actionArgsMap)
     case "El_End___ff1b":
         retVal = fe.El_End___ff1bFunc(actionArgsMap)
     case "El_SA01_SideAssembling_R____2d4e":
         retVal = fe.El_SA01_SideAssembling_R____2d4eFunc(actionArgsMap)
    default:
...
func (fe *Execution) El_FA01_FrameAssembling___6d9cFunc(actionArgsMap map[string]interface{}) bool {
...
func (fe *Execution) El_BAH01_BackSideHammerin___a27dFunc(actionArgsMap map[string]interface{}) bool {
...
func (fe *Execution) El_NT_SQ_04_PI001_Discard___bdecFunc(actionArgsMap map[string]interface{}) bool {
...
func (fe *Execution) El_BI01_BoxInspection___6ee4Func(actionArgsMap map[string]interface{}) bool {
...
func (fe *Execution) El_SA01_SideAssembling_L____bdc3Func(actionArgsMap map[string]interface{}) bool {
...
func (fe *Execution) El_Start___7defFunc(actionArgsMap map[string]interface{}) bool {
...
func (fe *Execution) El_PA01_Packaging___8f3dFunc(actionArgsMap map[string]interface{}) bool {
...
func (fe *Execution) El_End___ff1bFunc(actionArgsMap map[string]interface{}) bool {
...
func (fe *Execution) El_SA01_SideAssembling_R____2d4eFunc(actionArgsMap map[string]interface{}) bool {
