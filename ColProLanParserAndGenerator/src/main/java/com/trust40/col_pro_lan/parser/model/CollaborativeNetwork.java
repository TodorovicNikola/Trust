...
public class CollaborativeNetwork {
    private String id;
    private String name;
    private String endorsementPolicy;
    private List<Organization> organizations = new ArrayList<>();

    public CollaborativeNetwork() {}

    public CollaborativeNetwork(String id, String name, String endorsementPolicy) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        CollaborativeNetwork virtualOrganization = (CollaborativeNetwork) o;
