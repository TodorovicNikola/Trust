 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='onlyOneRelationBetweenElements flowBetweenStepsAndGates collaborationBetweenSteps'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot onlyOneRelationBetweenElements='\n\t\t\tRelationship.allInstances()-&gt;forAll(r1, r2 | ((r1.target.id = r2.target.id and r1.source.id = r2.source.id) or\n\t\t\t\t(r1.target.id = r2.source.id and r1.source.id = r2.target.id) implies (r1 = r2)))' flowBetweenStepsAndGates='\n\t\t\tRelationship.allInstances()-&gt;forAll(r | (r.type = ERelationshipType::FLOW) implies ((r.target.oclIsTypeOf(ProcessStep) or r.target.oclIsTypeOf(Gate)) and\n\t\t\t\t(r.source.oclIsTypeOf(ProcessStep) or r.source.oclIsTypeOf(Gate))))' collaborationBetweenSteps='\n\t\t\tRelationship.allInstances()-&gt;forAll(r | (r.type = ERelationshipType::COLLABORATION) implies (r.target.oclIsTypeOf(ProcessStep) and r.source.oclIsTypeOf(ProcessStep)))'"
 * @generated
 */
