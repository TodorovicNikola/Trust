...
public class Process_modelingPackageImpl extends EPackageImpl implements Process_modelingPackage {
	 ...
	 */
	@Override
	public EReference getPool_Swimlanes() {
	 ...
	 */
	@Override
	public EAttribute getSwimLane_OrganizationName() {
	 ...
	 */
	@Override
	public EAttribute getSwimLane_OrganizationRole() {
	 ...
	 */
	@Override
	public EReference getSwimLane_Elements() {
		return (EReference)swimLaneEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(poolEClass, POOL__SWIMLANES);

		swimLaneEClass = createEClass(SWIM_LANE);
		createEAttribute(swimLaneEClass, SWIM_LANE__ORGANIZATION_NAME);
		createEAttribute(swimLaneEClass, SWIM_LANE__ORGANIZATION_ROLE);
		createEReference(swimLaneEClass, SWIM_LANE__ELEMENTS);
	...
	public void initializePackageContents() {
		...
		poolEClass.getESuperTypes().add(this.getProcessElement());
		...
		initEReference(getPool_Swimlanes(), this.getSwimLane(), null, "swimlanes", null, 0, -1, Pool.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(swimLaneEClass, SwimLane.class, "SwimLane", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSwimLane_OrganizationName(), ecorePackage.getEString(), "OrganizationName", null, 1, 1, SwimLane.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSwimLane_OrganizationRole(), this.getEOrganizationRole(), "OrganizationRole", null, 1, 1, SwimLane.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSwimLane_Elements(), this.getProcessElement(), null, "elements", null, 0, -1, SwimLane.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
