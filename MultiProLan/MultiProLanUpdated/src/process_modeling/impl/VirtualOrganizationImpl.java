...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Virtual Organization</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link process_modeling.impl.VirtualOrganizationImpl#getOrganizations <em>Organizations</em>}</li>
 *   <li>{@link process_modeling.impl.VirtualOrganizationImpl#getEndorsementPolicy <em>Endorsement Policy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VirtualOrganizationImpl extends ProcessElementImpl implements VirtualOrganization {
	/**
	 ...
	 * @generated
	 */
	protected VirtualOrganizationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Process_modelingPackage.Literals.VIRTUAL_ORGANIZATION;
	}
	...
	public EList<Organization> getOrganizations() {
		if (organizations == null) {
			organizations = new EObjectContainmentEList<Organization>(Organization.class, this, Process_modelingPackage.VIRTUAL_ORGANIZATION__ORGANIZATIONS);
		}
	...
	public void setEndorsementPolicy(String newEndorsementPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Process_modelingPackage.VIRTUAL_ORGANIZATION__ENDORSEMENT_POLICY, oldEndorsementPolicy, endorsementPolicy));
	}
