...
public class Process_modelingAdapterFactory extends AdapterFactoryImpl {
	...
	protected Process_modelingSwitch<Adapter> modelSwitch =
		new Process_modelingSwitch<Adapter>() {
			...
			@Override
			public Adapter caseVirtualOrganization(VirtualOrganization object) {
				return createVirtualOrganizationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link process_modeling.VirtualOrganization <em>Virtual Organization</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
