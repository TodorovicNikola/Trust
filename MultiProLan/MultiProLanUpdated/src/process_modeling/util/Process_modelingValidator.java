...
public class Process_modelingValidator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case Process_modelingPackage.VIRTUAL_ORGANIZATION:
				return validateVirtualOrganization((VirtualOrganization)value, diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validateVirtualOrganization(VirtualOrganization virtualOrganization, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(virtualOrganization, diagnostics, context);
	}
