...
/**
 * This is the item provider adapter for a {@link process_modeling.SubProcess} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubProcessItemProvider extends ProcessElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubProcess_process_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubProcess_process_feature", "_UI_SubProcess_type"),
				 Process_modelingPackage.Literals.SUB_PROCESS__PROCESS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Process_modelingPackage.Literals.SUB_PROCESS__PARAMETERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Process_modelingPackage.Literals.SUB_PROCESS__PARAMETERS,
